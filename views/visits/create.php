...
$this->title = 'Добавить посещение врача';
$this->params['breadcrumbs'][] = ['label' => 'Посещения врачей', 'url' => ['index']];
...
<div class="doctor-visits-create">
    ...
    <?= $this->render('_form', [
        'model' => $model,
        'buttonClass' => 'btn-save-doctor-visit',
    ]) ?>
