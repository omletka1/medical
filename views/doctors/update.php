...
$this->title = 'Редактировать врача: ' . $model->first_name . ' ' . $model->last_name;
...
$this->registerCss(<<<CSS
    ...
    /* Стиль кнопки внутри формы (например, "Сохранить") */
    .btn-save-doctor {
    ...
    /* Стили для лейблов и полей формы */
    label {
        font-weight: 600;
        color: #004a99;
        margin-bottom: 6px;
