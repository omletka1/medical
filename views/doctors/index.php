...
<div class="doctors-index">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <?= Html::a('Добавить врача', ['create'], ['class' => 'btn btn-create-doctor']) ?>
            ...
            'columns' => [
                ...
                [
                    ...
                    'content' => function($model) {
                        return Html::tag('span', $model->specialization, ['class' => 'doctor-specialization']);
                    }
                ],
                [
                    'attribute' => 'phone',
    ...
    <div class="d-flex flex-wrap" id="cards-view">
        <?php foreach ($dataProvider->getModels() as $model): ?>
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p><strong>Специализация:</strong> <span class="doctor-specialization"><?= Html::encode($model->specialization) ?></span></p>
                    <p><strong>Телефон:</strong> <?= Html::a($model->phone, 'tel:'.$model->phone) ?></p>
                </div>
