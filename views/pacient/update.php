...
.pacient-update input[type="text"],
.pacient-update input[type="email"],
.pacient-update textarea {
...
.pacient-update input[type="text"]:focus,
.pacient-update input[type="email"]:focus,
.pacient-update textarea:focus {
    border-color: #007bff;
    outline: none;
