...
<style>
    ...
    .medications-form .form-group label {
        font-weight: 600;
        color: #0066cc;
    }

    .medications-form .form-control {
        border-radius: 8px;
    ...
    .medications-form .form-control:focus {
        border-color: #0066cc;
...
<div class="medications-form">
    ...
    <?= $form->field($model, 'name')->textInput(['maxlength' => true])->label('Название лекарства') ?>
